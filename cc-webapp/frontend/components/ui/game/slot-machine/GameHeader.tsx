        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="text-center">
              <div className="text-amber-200 font-bold text-sm">잔액</div>

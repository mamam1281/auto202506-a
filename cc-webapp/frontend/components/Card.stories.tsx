  ...
  args: {
    ...
    children: (
      <div className="space-y-[var(--spacing-6)]">
        <p className="text-[var(--color-text-secondary)] text-[var(--font-size-sm)] leading-relaxed">
          특별한 혜택을 확인해보세요!
        </p>
  ...
  args: {
    ...
    headerRight: (      <Button iconOnly variant="text" size="md" onClick={action('settings clicked')}>
      ...
      <div className="space-y-[var(--spacing-6)]">
        ...
        <div className="flex items-center justify-between py-[10px]">
          <span className="text-[var(--color-text-secondary)] text-[var(--font-size-sm)]">소리 알림</span>
  ...
  args: {
    ...
    children: (
      <div className="space-y-[var(--spacing-4)]">
        ...
        <p className="text-[var(--color-text-secondary)] text-[var(--font-size-xs)] leading-relaxed">
          카드를 클릭하면 호버 리프트 효과와 함께 이벤트가 발생합니다.
        </p>
        <div className="text-center pt-[var(--spacing-2)]">
          <span className="text-[var(--color-purple-primary)] text-[var(--font-size-caption)] font-medium">
            👆 카드를 클릭해보세요!
          </span>
        </div>
      </div>
    ...
    headerRight: (      <div className="flex gap-1">
      ...
      <div className="space-y-[var(--spacing-5)]">
        <div className="grid grid-cols-2 gap-[var(--spacing-4)]">
          <div className="text-center p-[var(--spacing-4)] bg-[var(--color-purple-primary)]/10 rounded-[var(--radius-md)]">
            <div className="text-[var(--font-size-h2)] font-[var(--font-weight-bold)] text-[var(--color-purple-primary)]">
              1,234
            </div>
            <div className="text-[var(--font-size-xs)] text-[var(--color-text-secondary)] mt-[var(--spacing-1)]">
              총 포인트
            </div>
          </div>
          <div className="text-center p-[var(--spacing-4)] bg-green-500/10 rounded-[var(--radius-md)]">
        ...
        </div>        <div className="space-y-[var(--spacing-3)]">
          <div className="flex justify-between items-center text-[var(--font-size-sm)]">
            ...
            <span className="text-[var(--foreground)] font-medium">78%</span>
          </div>
          <div className="w-full bg-gray-700 rounded-full h-4 overflow-hidden border border-gray-600">
            <div 
              className="bg-gradient-to-r from-purple-500 via-blue-500 to-purple-400 h-4 rounded-full transition-all duration-500 shadow-lg" 
              style={{ width: '78%' }}
            ></div>
          </div>
        </div>
...
export const GridDemo: Story = {
  render: () => (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-[var(--spacing-3)] max-w-7xl">      {/* 첫 번째 행 */}
      <Card title="간단한 알림">
      ...
      <Card title="포인트">
        <div className="text-center py-[10px]">
          ...
          <div className="text-[var(--font-size-xs)] text-[var(--color-text-secondary)] mt-[10px]">
            현재 포인트
          </div>
        </div>
      </Card>      {/* 두 번째 행 */}
      ...
      <Card title="보상함">
        <div className="text-center space-y-[10px] py-[10px]">
...
export const GameStats: Story = {
  args: {
    title: '게임 통계',
    children: (
      <div className="grid grid-cols-2 gap-y-[var(--spacing-5)] gap-x-[var(--spacing-4)] place-items-center text-center">
        {/* 총 포인트 섹션 */}
        <div className="py-[var(--spacing-3)]">
          <h4 className="text-[var(--font-size-h4)] font-[var(--font-weight-bold)] text-[var(--foreground)] mb-[var(--spacing-1)]">1,234</h4>
          <p className="text-[var(--color-text-secondary)] text-[var(--font-size-caption)]">총 포인트</p>
        </div>

        {/* 승률 섹션 */}
        <div className="py-[var(--spacing-3)]">
          <h4 className="text-[var(--font-size-h4)] font-[var(--font-weight-bold)] text-[var(--foreground)] mb-[var(--spacing-1)]">89%</h4>
          <p className="text-[var(--color-text-secondary)] text-[var(--font-size-caption)]">승률</p>
        </div>

        {/* 이번 주 진행률 섹션 (2열 차지) */}
        <div className="col-span-2 flex flex-col items-center mt-[var(--spacing-4)] py-[var(--spacing-3)]">
          <p className="text-[var(--color-text-secondary)] text-[var(--font-size-caption)] mb-[var(--spacing-2)]">이번 주 진행률</p>
          <div className="w-full max-w-[200px] bg-[var(--color-primary-charcoal)] rounded-full h-2 mb-[var(--spacing-2)]">
            <div className="bg-gradient-to-r from-[var(--color-accent-red)] to-[var(--color-accent-amber)] h-2 rounded-full" style={{width: '78%'}}></div>
          </div>
          <span className="text-[var(--foreground)] text-[var(--font-size-body)]">78%</span>
        </div>
      </div>
    ),
  },
  ...
  args: {
    ...
    headerRight: (
      ...
      <div className="space-y-[var(--spacing-2)]">
        ...
        <div className="flex justify-between items-center py-[var(--spacing-3)]">
          <span className="text-[var(--foreground)] text-[var(--font-size-body)]">푸시 알림</span>
          <Button variant="primary" size="md">켜기</Button>
        </div>
        <div className="flex justify-between items-center py-[var(--spacing-3)]">
          <span className="text-[var(--foreground)] text-[var(--font-size-body)]">이메일 알림</span>
          <Button variant="glass" size="md">끄기</Button>
        </div>
        <div className="flex justify-between items-center py-[var(--spacing-3)]">
          <span className="text-[var(--foreground)] text-[var(--font-size-body)]">소리 알림</span>
          <Button variant="primary" size="md">켜기</Button>
        </div>
        <div className="flex justify-between items-center py-[var(--spacing-3)]">
          <span className="text-[var(--foreground)] text-[var(--font-size-body)]">진동 알림</span>
          <Button variant="glass" size="md">끄기</Button>
        </div>
      </div>
    ),
